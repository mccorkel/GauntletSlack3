...
namespace GauntletSlack3.Api.Migrations
{
    ...
    [Migration("20250108074311_SeedSampleData")]
            ...
            modelBuilder.Entity("GauntletSlack3.Shared.Models.Channel", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2025, 1, 8, 7, 43, 11, 405, DateTimeKind.Utc).AddTicks(2891),
                            Name = "general",
                            OwnerId = "admin",
                            Type = "public"
                        });
            ...
            modelBuilder.Entity("GauntletSlack3.Shared.Models.ChannelMembership", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            UserId = "admin",
                            IsMuted = false,
                            JoinedAt = new DateTime(2025, 1, 8, 7, 43, 11, 405, DateTimeKind.Utc).AddTicks(2891)
                        });
                });
